...
prepped[grepl('meat', prepped$rei_name),'rei_name'] <- 'high_meat'
prepped[grepl('physical', prepped$rei_name),'rei_name'] <- 'low_exercise'
prepped[grepl('alcohol', prepped$rei_name),'rei_name'] <- 'alcohol_use'
prepped[grepl('drug', prepped$rei_name),'rei_name'] <- 'drug_use'
...
wide.data <- wide.data %>% 
              rename(super_region = super.region, 
